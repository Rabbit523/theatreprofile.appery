define(['require', 'angular', 'angular-touch', '$App/fmodals', '$App/fhelper', '$App/fconfig', "appery-ui", "angular-route",
    '$App/crouterconfig', '$App/crestinterrupt', '$App/frest', '$App/slogin', '$App/sentity'
    ...
    return angular.module('ApperyioModule', ['ngTouch', 'ngRoute', 'ui.appery'])
        ...
        .service('Apperyio', [
            '$rootScope', "$location", "$injector", '$q', '$parse', '$timeout', 'Apperyio.Config', 'EntityAPI', require('$App/fhelper')
        ])
        .factory('Modals', ['$templateCache', 'Apperyio', require('$App/fmodals')])
