/**
 * Module initializes rest service rstudioTPuserValidCheck
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'rstudioTPuserValidCheck',
        deps: ['Apperyio', 'REST', rstudioTPuserValidCheckImpl]
    }];
    /**
     * @function rstudioTPuserValidCheckImpl
     */
    function rstudioTPuserValidCheckImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "get",
            headers: Apperyio.EntityAPI("rstudioTPuserValidCheck.request.headers"),
            params: Apperyio.EntityAPI("rstudioTPuserValidCheck.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "rstudioTPuserValidCheck"
            }
        };
