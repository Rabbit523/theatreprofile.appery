/**
 * Module initializes rest service TheatreProfile_SelUser_update_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'TheatreProfile_SelUser_update_service',
        deps: ['Apperyio', 'REST', TheatreProfile_SelUser_update_serviceImpl]
    }];
    /**
     * @function TheatreProfile_SelUser_update_serviceImpl
     */
    function TheatreProfile_SelUser_update_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/db/collections/SelUser/{_id}",
            method: "put",
            headers: Apperyio.EntityAPI("TheatreProfile_SelUser_update_service.request.headers"),
            params: Apperyio.EntityAPI("TheatreProfile_SelUser_update_service.request.query"),
            data: Apperyio.EntityAPI("TheatreProfile_SelUser_update_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "TheatreProfile_SelUser_update_service"
            }
        };
