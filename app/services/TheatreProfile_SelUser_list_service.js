/**
 * Module initializes rest service TheatreProfile_SelUser_list_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'TheatreProfile_SelUser_list_service',
        deps: ['Apperyio', 'REST', TheatreProfile_SelUser_list_serviceImpl]
    }];
    /**
     * @function TheatreProfile_SelUser_list_serviceImpl
     */
    function TheatreProfile_SelUser_list_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
         ...
         */
        this.config = {
            url: "https://api.appery.io/rest/1/db/collections/SelUser",
            method: "get",
            headers: Apperyio.EntityAPI("TheatreProfile_SelUser_list_service.request.headers"),
            params: Apperyio.EntityAPI("TheatreProfile_SelUser_list_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "TheatreProfile_SelUser_list_service"
            }
        };
