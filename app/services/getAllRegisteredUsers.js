/**
 * Module initializes rest service getAllRegisteredUsers
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'getAllRegisteredUsers',
        deps: ['Apperyio', 'REST', getAllRegisteredUsersImpl]
    }];
    /**
     * @function getAllRegisteredUsersImpl
     */
    function getAllRegisteredUsersImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "get",
            headers: Apperyio.EntityAPI("getAllRegisteredUsers.request.headers"),
            params: Apperyio.EntityAPI("getAllRegisteredUsers.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "getAllRegisteredUsers"
            }
        };
