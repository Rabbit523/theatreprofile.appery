/**
 * Module initializes rest service TheatreProfile_user_update_service
 */
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'TheatreProfile_user_update_service',
        deps: ['Apperyio', 'REST', TheatreProfile_user_update_serviceImpl]
    }];
    /**
     * @function TheatreProfile_user_update_serviceImpl
     */
    function TheatreProfile_user_update_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "put",
            headers: Apperyio.EntityAPI("TheatreProfile_user_update_service.request.headers"),
            params: Apperyio.EntityAPI("TheatreProfile_user_update_service.request.query"),
            data: Apperyio.EntityAPI("TheatreProfile_user_update_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "TheatreProfile_user_update_service"
            }
        };
