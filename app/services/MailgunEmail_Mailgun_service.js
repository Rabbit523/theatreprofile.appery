...
define(['require'], function(require) {
    return [{
        type: 'service',
        name: 'MailgunEmail_Mailgun_service',
        deps: ['Apperyio', 'REST', MailgunEmail_Mailgun_serviceImpl]
    }];
    /**
     * @function MailgunEmail_Mailgun_serviceImpl
     */
    function MailgunEmail_Mailgun_serviceImpl(Apperyio, REST) {
        var REST = new REST();
        /**
        ...
        this.config = {
            ...
            method: "get",
            headers: Apperyio.EntityAPI("MailgunEmail_Mailgun_service.request.headers"),
            params: Apperyio.EntityAPI("MailgunEmail_Mailgun_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
