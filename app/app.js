define(
    [
         ...
         * Angular modules
         */
        "ionic", "gmaps", "angular-nvd3", "tooltips", "angular-chart",
        /**
         * Custom global resources
         */
        "navigateTo", "backButton", "d3", "nvd3", "rstudioTPattendanceByShow", "rstudioTPorganizationsList", "rstudioTPshowAttendanceDetails", "rstudioTPticketsByZipCode", "rstudioTPallCompanies", "rstudioTPcompanyShowsPerformance", "TheatreProfile_Keys_read_service", "rstudioTPshowEventDetails", "rstudioTPshowEventGeography", "Secret_Keys_read_service", "rstudioTPshowPeerComparison", "TPretrieveUserInformation", "TPgetUserIPAddress", "rstudioTPcompaniesLinkedUserID", "rstudioTPuserValidCheck", "TheatreProfile_user_update_service", "TheatreProfile_SelUser_update_service", "TheatreProfile_SelUser_list_service", "list_usersel_service", "update_usersel_service", "chart", "MailgunEmail_Mailgun_service", "getAllRegisteredUsers"
    ],
    function() {
         ...
         */
        var APP = angular.module(window.__APPLICATION_NAME, ['ApperyioModule', "ionic", "uiGmapgoogle-maps", "nvd3", "tooltips", "angular-chart"])
            .config([
                "$routeProvider",
                '$controllerProvider',
                '$provide',
