module.exports = function(grunt) {
        ...
        copy: {
            tmpApp: {
                ...
                src: [
                    ...
                    "!libs/ionic/ionic.bundle.min.js",
    ...
    grunt.registerTask('default', [
        'clean:before', 'copy:tmpApp',
        'replace:buildWithoutTests', 'requirejs:compile',
        'cssmin:build', 'copy:restoreAngular',
        'clean:unused', 'replace:buildindex'
    ]);
    ...
    grunt.registerTask('build_release_and_clean', [
        ...
        'cssmin:build', 'copy:restoreAngular',
        'clean:unused', 'replace:buildindex',
        'clean:after', 'copy:restoreStructure',
        'clean:finalClean'
    ]);
};